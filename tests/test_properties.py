...
sim_config_strategy = st.builds(
    ...
    num_days=st.integers(min_value=50, max_value=200),
    num_individuals=st.integers(min_value=50, max_value=500),
    num_food_firms=st.integers(min_value=1, max_value=6),
    num_energy_firms=st.integers(min_value=1, max_value=6),
    num_shelter_firms=st.integers(min_value=1, max_value=6),
